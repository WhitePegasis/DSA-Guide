...
Space Complexity : O(1) A more optimized solution to this problem is possible using HashMaps. 
Which will take: Time Complexity: O(n + m) 
Space Complexity : O(min(n, m)) Where 'n' and 'm' are the sizes of the input arrays/lists */ 
