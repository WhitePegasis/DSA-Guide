...
{ 
    ...
    { 
        ...
        if(input.length() >= 2) { firstTwoDigits = (input.charAt(0) - '0') * 10 + (input.charAt(1) - '0'); 
        ...
        int k = 0; for(String s : smallOutput1){ char firstDigitChar = getChar(firstDigit); // (char)('a'-1+lastDigit) 
